...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function selectGroup(groupId) {
        ...
        currentUserRole = selectedGroup.members ? selectedGroup.members[userId] : null;

        const isCreator = currentUserRole === 'admin' || currentUserRole === 'creator';
        const isAdmin = currentUserRole === 'admin';

        document.getElementById('add-song-btn').style.display = isCreator ? 'block' : 'none';
        document.getElementById('add-rehearsal-btn').style.display = isCreator ? 'block' : 'none';
        document.getElementById('add-member-btn').style.display = isAdmin ? 'block' : 'none';
        document.getElementById('delete-group-btn').style.display = (isAdmin && selectedGroup.owner === userId) ? 'block' : 'none';
